...
namespace NodePad.Model
{
    public static class Star4Procs
    {
        ...
        public static IEnumerable<P2V<int, float>> CurValuesAsP2Vs(this Star4Grid starGrid)
        {
            return A2dUt.ToP2V(starGrid.Stars).Select(s =>
                new P2V<int, float>(x: s.X, y: s.Y, v: s.V.CurValue));
        }

        public static IEnumerable<P2V<int, float>> CurDeltasAsP2Vs(this Star4Grid starGrid)
        {
            return A2dUt.ToP2V(starGrid.Stars).Select(s =>
